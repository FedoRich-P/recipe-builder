...
import { addRecipe, setSearchTerm } from '@/features/recipe/recipeSlice';
...
export const Sidebar = () => {
    ...
    return (
        <>
            <aside
                className={`fixed lg:sticky top-0 left-0 h-screen w-120 bg-white shadow-lg z-40 transition-all duration-300 ${
                ...
                <div className="p-5 h-full flex flex-col overflow-y-auto">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 mb-6">Recipe Manager</h2>
