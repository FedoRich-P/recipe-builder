...
import { useGetRecipeByIdQuery } from '@/entities/recipe/api/recipesApi';
import { Loader } from '@/shared/ui/Loader';
import { NotFound } from '@/pages/NotFound/NotFound';
import { RecipeDetails } from '@/widgets/recipe-details/RecipeDetails';
    ...
    <div className="relative min-h-screen">
      {recipe.imageUrl && (
        <div className="absolute inset-0 z-0">
          <img src={recipe.imageUrl} alt={recipe.name} className="w-full h-full object-cover brightness-60" />
...
// import { useNavigate, useParams } from 'react-router-dom';
// import { useGetRecipeByIdQuery, useUpdateRecipeMutation } from '@/entities/recipe/api/recipesApi';
// import { Loader } from '@/shared/ui/Loader';
// import { NotFound } from '@/pages/NotFound/NotFound';
