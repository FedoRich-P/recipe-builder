...
// import { useGetRecipeByIdQuery } from '@/features/recipe/model/recipesApi';
...
//               <RecipeItem recipe={recipe} isFavorite={recipe.favorite} className={'min-h-[50vh] block'} isMainPage={true} />
