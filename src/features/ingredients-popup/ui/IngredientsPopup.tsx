...
interface IngredientsPopupProps {
  ...
  onClose: () => void;
  moreButtonRef: React.RefObject<HTMLSpanElement | null>;
}
...
export const IngredientsPopup = ({ ingredients, onClose, moreButtonRef }: IngredientsPopupProps) => {
  ...
  return (
    <Popup onClose={onClose} moreButtonRef={moreButtonRef}>
      <div className="relative pr-10">
        <h4 className="text-lg font-semibold mb-2 text-gray-800 truncate pr-6">Все ингредиенты</h4>
